...
void WS2811::ConfigureTimerPeripheral(uint32_t frequency, uint16_t maxValue)
{
	...
	_handle.Init.Period = maxValue - 1; // this will allow duty cycles (CCR register) to go from 0 to maxValue, with maxValue giving 100% duty cycle (fully on)
