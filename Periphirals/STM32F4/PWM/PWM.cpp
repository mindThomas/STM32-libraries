...
PWM::PWM(timer_t timer, pwm_channel_t channel, uint32_t frequency, uint16_t maxValue, bool invert)
    : _channel(channel)
    , _channelHAL(0)
{
...
PWM::PWM(timer_t timer, pwm_channel_t channel)
    : PWM(timer, channel, 0, 0, false)
{}

PWM::PWM(timer_t timer, pwm_channel_t channel, bool invert)
    : PWM(timer, channel, 0, 0, invert)
{}
