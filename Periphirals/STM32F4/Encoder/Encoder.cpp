...
extern "C" __EXPORT void TIM5_IRQHandler(void);
...
void TIM5_IRQHandler(void)
{
	if (Encoder::resTIMER5)
		...
		TIM5->SR = ~(uint32_t)(TIM_IT_UPDATE | TIM_IT_CC1 | TIM_IT_CC2 | TIM_IT_CC3 | TIM_IT_CC4 | TIM_IT_COM | TIM_IT_TRIGGER | TIM_IT_BREAK); // clear all interrupts
}
