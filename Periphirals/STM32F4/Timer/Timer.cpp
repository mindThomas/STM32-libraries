...
void TIM1_TRG_COM_TIM11_IRQHandler(void)
{
    if (Timer::resTIMER11)
        ...
        TIM11->SR = ~(uint32_t)(TIM_IT_UPDATE | TIM_IT_CC1 | TIM_IT_CC2 | TIM_IT_CC3 | TIM_IT_CC4 | TIM_IT_COM |
...
void TIM8_UP_TIM13_IRQHandler(void)
{
    if (Timer::resTIMER13)
        ...
        TIM13->SR = ~(uint32_t)(TIM_IT_UPDATE | TIM_IT_CC1 | TIM_IT_CC2 | TIM_IT_CC3 | TIM_IT_CC4 | TIM_IT_COM |
                                TIM_IT_TRIGGER | TIM_IT_BREAK); // clear all interrupts
}
...
void TIM8_TRG_COM_TIM14_IRQHandler(void)
{
    if (Timer::resTIMER14)
        ...
        TIM14->SR = ~(uint32_t)(TIM_IT_UPDATE | TIM_IT_CC1 | TIM_IT_CC2 | TIM_IT_CC3 | TIM_IT_CC4 | TIM_IT_COM |
                                TIM_IT_TRIGGER | TIM_IT_BREAK); // clear all interrupts
}
