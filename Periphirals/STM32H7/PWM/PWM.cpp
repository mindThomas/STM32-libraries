...
#define ADD_CASE(TIMER)                                                                                                \
    case TIMER:                                                                                                        \
        if (!res##TIMER) { /* only configure if frequency and maxValue is set */                                       \
            if (frequency > 0 && maxValue > 0) {                                                                       \
                res##TIMER = new PWM::hardware_resource_t;                                                             \
                memset(res##TIMER, 0, sizeof(PWM::hardware_resource_t));                                               \
