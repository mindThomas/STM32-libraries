...
void svd_5x5(const float Ain[25], float U[25], float S[25], float V[25])
{
    ...
    arm_mat_init_f32(&Ain_, 5, 5, (float32_t*)Ain);
    float                   A[5 * 5];
    arm_matrix_instance_f32 A_;
    arm_mat_init_f32(&A_, 5, 5, (float32_t*)A);
    ...
    arm_mat_init_f32(&U_, 5, 5, (float32_t*)U);
    arm_matrix_instance_f32 S_;
    arm_mat_init_f32(&S_, 5, 5, (float32_t*)S);
    arm_matrix_instance_f32 V_;
    arm_mat_init_f32(&V_, 5, 5, (float32_t*)V);
