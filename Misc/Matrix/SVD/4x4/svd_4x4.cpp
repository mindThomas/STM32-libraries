...
void svd_4x4(const float Ain[16], float U[16], float S[16], float V[16])
{
    ...
    arm_mat_init_f32(&Ain_, 4, 4, (float32_t*)Ain);
    float                   A[4 * 4];
    arm_matrix_instance_f32 A_;
    arm_mat_init_f32(&A_, 4, 4, (float32_t*)A);
    ...
    arm_mat_init_f32(&U_, 4, 4, (float32_t*)U);
    arm_matrix_instance_f32 S_;
    arm_mat_init_f32(&S_, 4, 4, (float32_t*)S);
    arm_matrix_instance_f32 V_;
    arm_mat_init_f32(&V_, 4, 4, (float32_t*)V);
