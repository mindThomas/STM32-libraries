...
void svd_2x2(const float Ain[4], float U[4], float S[4], float V[4])
{
  ...
  arm_matrix_instance_f32 Ain_; arm_mat_init_f32(&Ain_, 2, 2, (float32_t *)Ain);
  float A[2*2]; arm_matrix_instance_f32 A_; arm_mat_init_f32(&A_, 2, 2, (float32_t *)A);
  ...
  arm_matrix_instance_f32 U_; arm_mat_init_f32(&U_, 2, 2, (float32_t *)U);
  arm_matrix_instance_f32 S_; arm_mat_init_f32(&S_, 2, 2, (float32_t *)S);
  arm_matrix_instance_f32 V_; arm_mat_init_f32(&V_, 2, 2, (float32_t *)V);  
