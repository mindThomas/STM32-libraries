...
void svd_6x6(const float Ain[36], float U[36], float S[36], float V[36])
{
  ...
  arm_matrix_instance_f32 Ain_; arm_mat_init_f32(&Ain_, 6, 6, (float32_t *)Ain);
  float A[6*6]; arm_matrix_instance_f32 A_; arm_mat_init_f32(&A_, 6, 6, (float32_t *)A);
  ...
  arm_matrix_instance_f32 U_; arm_mat_init_f32(&U_, 6, 6, (float32_t *)U);
  arm_matrix_instance_f32 S_; arm_mat_init_f32(&S_, 6, 6, (float32_t *)S);
  arm_matrix_instance_f32 V_; arm_mat_init_f32(&V_, 6, 6, (float32_t *)V);  
