...
Heartbeat::Heartbeat(uint16_t heartbeatFrequency, LSPC& lspc, uint32_t heartbeatTaskPriority) : _heartbeatFrequency(heartbeatFrequency), _heartbeatTaskHandle(0), _lspc(lspc)
{
	xTaskCreate(Heartbeat::HeartbeatThread, (char *)"Heartbeat", HEARTBEAT_THREAD_STACK, (void*) this, heartbeatTaskPriority, &_heartbeatTaskHandle);
}
