...
CPULoad::CPULoad(LSPC& lspc, uint32_t cpuLoadTaskPriority) : _lspc(lspc), _cpuLoadTaskHandle(0)
{
	xTaskCreate(CPULoad::CPULoadThread, (char *)"CPU Load", CPULOAD_THREAD_STACK, (void*) this, cpuLoadTaskPriority, &_cpuLoadTaskHandle);
}
